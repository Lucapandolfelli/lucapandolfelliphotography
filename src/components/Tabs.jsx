        ...
        {categories?.map((tab, index) => (
          <li key={tab.id} className='min-w-[150px] md:w-[calc(100%/6)]'>
            <button 
              ...
              className={ currentTab === index ? 'uppercase bg-gray-300 dark:bg-[#252525] text-sm w-full h-full flex justify-center items-center' : 'uppercase bg-gray-100 dark:bg-[#333] text-sm w-full h-full flex justify-center items-center hover:bg-gray-200 dark:hover:bg-[#616161]'}>
